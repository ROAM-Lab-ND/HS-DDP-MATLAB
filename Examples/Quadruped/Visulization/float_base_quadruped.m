...
body_roll = rigidBody('vbody_roll');
...
addBody(float_base_robot, body_roll, 'vbody_z');
...
addBody(float_base_robot, body_pitch, 'vbody_roll');

body_yaw = copy(robot.Base);
...
addBody(float_base_robot, body_yaw, 'vbody_pitch');
...
addSubtree(float_base_robot, body_yaw.Name, leg_fr);
addSubtree(float_base_robot, body_yaw.Name, leg_fl);
addSubtree(float_base_robot, body_yaw.Name, leg_hr);
addSubtree(float_base_robot, body_yaw.Name, leg_hl);
